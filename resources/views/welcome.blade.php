...
<body class="nav-fixed">
        ...
        <ul class="navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown no-caret me-3 d-lg-none">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="searchDropdown"
                    href="starter-minimal.html#" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
            ...
            <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                    ...
                    <a class="dropdown-item dropdown-notifications-footer" href="starter-minimal.html#!">View All
                        Alerts</a>
                </div>
            </li>
            <!-- Messages Dropdown-->
            <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                    ...
                    <!-- Footer Link-->
                    <a class="dropdown-item dropdown-notifications-footer" href="starter-minimal.html#!">Read All
                        Messages</a>
                </div>
            </li>
            <!-- User Dropdown-->
                    ...
                    <h6 class="dropdown-header d-flex align-items-center">
                        ...
                        <div class="dropdown-user-details">
                            ...
                            <div class="dropdown-user-details-email"><a href="cdn-cgi/l/email-protection.html"
                                    class="__cf_email__"
                                    data-cfemail="b2c4dec7dcd3f2d3ddde9cd1dddf">[email&#160;protected]</a></div>
                        </div>
                    </h6>
            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <!-- Sidenav Link (Alerts)-->
                        <!-- * * Note: * * Visible only on and above the sm breakpoint-->
                        <a class="nav-link d-sm-none" href="starter-minimal.html#!">
            ...
            <main>
                ...
                <div class="container-xl px-4 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body">This is a blank page. You can use this page as a boilerplate for creating
                            new pages! This page uses the compact page header format, which allows you to create pages
                            with a very minimal and slim page header so you can get right to showcasing your content.
                        </div>
                    </div>
                </div>
            </main>
                ...
                <div class="container-xl px-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-md-end small">
                            <a href="starter-minimal.html#!">Privacy Policy</a>
                            ·
                            <a href="starter-minimal.html#!">Terms &amp; Conditions</a>
                        </div>
                    </div>
                </div>
            </footer>
    ...
    <script>
        (function () {
            var js =
                "window['__CF$cv$params']={r:'750b4bde2cff073a',m:'zAiTniXbN3iuVfwoNW8acSVAWGSIZHWUG_60ftJIEvg-1664187934-0-AQuojbVj7gzrJzA9E3tCpGpolq+pVu1MKHwrCSc4WTBtQ8ivR3SQQi76ZaGL+myiwGIqyx9zPUtcO0BqwunLGI8T0XkBFdmPsp1UNubBlzmeuLvVsmOVgRTMlkN0f77XVVbZ1SOdIhEKWbZ5nhQzAmM=',s:[0x915f645c0a,0xaaca5abb33],u:'/cdn-cgi/challenge-platform/h/g'};var now=Date.now()/1000,offset=14400,ts=''+(Math.floor(now)-Math.floor(now%offset)),_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/h/g/scripts/alpha/invisible.js?ts='+ts,document.getElementsByTagName('head')[0].appendChild(_cpo);";
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v652eace1692a40cfa3763df669d7439c1639079717194"
        ...
        data-cf-beacon='{"rayId":"750b4bde2cff073a","token":"6e2c2575ac8f44ed824cef7899ba8463","version":"2022.8.1","si":100}'
